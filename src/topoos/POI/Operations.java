...
public class Operations {
	...
	/**
	 * Add a new point of interest (POI).Fields like address, 
	 * cross_street, city, country, and postalCode not specified, it will attempt to automatically generate
	 * @param name (required) access_token to user resources
	 * @param lat (required)  latitude of the new position
	 * @param lng (required)  longitude  of the new position.
	 * @param categories (required) identifiers for the categories to which the POI belongs
	 ...
	 * @param desc (optional) description of the landmark
	 * @param address (optional)  direction of the point of interest
	 * @param cross_street (optional)  cross street
	 * @param city (optional) city landmark
	 * @param country (optional) country
	 * @param postal_code (optional) postal code 
	 * @param phone (optional) Contact phone
	 * @param twitter (optional) user ID or hashtag of Twitter
	 * @param accessTokenPregenerated (required) access_token to user
	 *        resources
	 * @return POI 
	 * @throws IOException
	 ...
	 * @param POIID (required) point of interest identifier
	 * @param accessTokenPregenerated (required) access_token to user
	 *        resources 
	 * @return POI
	 * @throws IOException
	 ...
	 * @param categories (required) identifiers for the categories to which the POI belongs  
	 * @param POIS (optional) list of identifiers of POI you want to retrieve, separated by commas
	 * @param city (optional) gets the POI in the city specified
	 * @param country (optional) country
	 * @param postal_code (optional) postal code
	 * @param q (optional) gets the POI whose name or description matched the pattern
	 * @param accessTokenPregenerated (required) access_token to user
	 *        resources 
	 * @return List<POI>
	 * @throws IOException
	...
	/**
	 * Upgrade the point of interest with the new information provided. If you want to erase 
	 * @param POIID
	 * @param name
	 * @param lat
	 * @param lng
