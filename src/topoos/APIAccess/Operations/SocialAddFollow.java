...
/**
 * Class that add Follows.
 * 
 * @see APIOperation
 * @author topoos
 */
public class SocialAddFollow extends APIOperation {
	...
	/**
	 * Instantiates a new Social follow add.
	 * 
	 * @param operationName
	 *            the operation name
	 * @param method
	 ...
	 *            the user_b
	 */
	public SocialAddFollow(String operationName, String method, String format,
