 ...
 * @author topoos
 */
public class SocialGetFriendRecommendations extends APIOperation {
	...
	/**
	 * Instantiates a new Social get friend recommendations.
	 * 
	 * @param operationName
	 *            the operation name
	 * @param method
	 ...
	 *            the USR
	 */
	public SocialGetFriendRecommendations(String operationName, String method, String format,
