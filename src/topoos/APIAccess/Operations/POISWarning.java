...
public class POISWarning extends APIOperation{
	...
	private String	poi=null; // (opcional) lista de identificadores de POI cuyos warnings deseamos recuperar, separados por comas
	...
	public String ConcatParams() {
		...
		if (this.ValidateParams()) {
			params = "/" + this.Version + "/pois/warnings."
					+ this.Format 
