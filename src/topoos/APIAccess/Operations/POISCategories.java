...
public class POISCategories extends APIOperation{
	...
	//	true =null; // (default) la respuesta incluye las categorías del sistema predefinidas por el API
	...
	public boolean ValidateParams() {
		...
		validate = validate && isValidorNull(APIUtils.toStringBoolean(include_system_categories));
	...
	public String ConcatParams() {
		...
		if (this.ValidateParams()) {
			params = "/" + this.Version + "/pois/categories." + this.Format 
					+ "?oauth_token=" + this.oauth_token
					+(include_system_categories == null? "&include_system_categories=true" : "&include_system_categories="+APIUtils.toStringBoolean(include_system_categories));
		}
		return params;
	}
}